class Constants:
    ...
    CONFIG_FIELD_MODALITY_REQUIRED = ["name", CONFIG_FIELD_MODALITY_TYPE]

    CONFIG_FIELD_SAMPLE = "samples"
    CONFIG_FIELD_SAMPLE_DESCRIPTION = "description"
    CONFIG_FIELD_SAMPLE_REQUIRED = ["name", CONFIG_FIELD_MODALITY]
    ...
    CONFIG_FIELD_MODEL_REQUIRED = [CONFIG_FIELD_MODEL_COMPONENT]
