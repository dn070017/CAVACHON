...
class DataLoader:
    ...
    n_vars_batch_effect: Dict[str, int]
        ...
        are the modality names, the values are the numbers of variables
        of the corresponding batch effect tensor.
    ...
    def __init__(
        ...
        distribution_names: Mapping[str, str] = dict(),
        ...
        batch_size: int, optional
            batch size used to create Iterator of dataset. Defaults to
            128.
        ...
        batch_effect_colnames: Optional[Mapping[str, List[str]]], optional
            ...
            adata.uns['cavachon']['batch_effect_colnames'] will be
            used. Defaults to {}.
        ...
        distribution_names: Optional[Mapping[str, str]], optional
            ...
            adata.uns['cavachon']['distribution'] will be used.
            Defaults to {}.
    ...
    def create_dataset(
        self, batch_effect_colnames: Mapping[str, List[str]] = dict()
    ) -> tf.data.Dataset:
        """Create a Tensorflow Dataset based on the MuData provided in
    ...
    def setup_batch_effect_tensor(
        ...
        if batch_effect_colnames_modality is None or len(batch_effect_colnames_modality) == 0:
            ...
            batch_effect_tensor, encoder_mapping = TensorUtils.create_tensor_from_df(
                adata.obs,
                batch_effect_colnames_modality,
    ...
    def modify_dataset(self, distribution_names: Mapping[str, str] = dict()) -> None:
    ...
    def __iter__(self) -> Iterator[tf.data.Dataset]:
        ...
        ------
        Dict[Any, tf.Tensor]:
            batch of data, where the field of the batched dataset
            includes:
    ...
    def from_h5mu(cls, h5mu_path: str, batch_size: int = 128) -> DataLoader:
        ...
        the batch effect columns for each modality need to be stored in
    ...
    def save_dataset(self, datadir: str) -> None:
        ...
        ----------
        datadir: str
            directory where the Tensorflow Dataset snapshot will be
            save.
