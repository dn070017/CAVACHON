...
class MultivariateNormalDiagParameterizer(Parameterizer):
    ...
    function generate one single tf.Tensor which can be considered as
    the loc and scale_diag for MultivariateNormalDiag distribution, and
    ...
    See Also
    --------
    distributions.MultivariateNormalDiagDistribution
        the compatible distribution

    layers.parameterizer.MultivariateNormalDiag
    ...
    def __init__(self, *args, **kwargs):
        """Constructor for MultivariateNormalDiagParameterizer. Should
