...
class Parameterizer(tf.keras.Model):
    ...
    This class is used in the modules/components and modules/Model.
    Note that, most of the modules/parameterizers uses the layers
    implemented in layers/parameterizers but this is not required. It
    is possible to simply use the modules/parameterizers if developers
    want to make custom Parameterizer. By defaults, the call() function
    expects a Mapping of tf.Tensor with 'input' (and 'libsize' if
    libsize_scaling is set to True) and other custom keys. The call()
    function generate one single tf.Tensor as outputs.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        inputs: Mapping[str, tf.Tensor]
            ...
            functional API. Expect to have key 'input' by default.
        ...
        kwargs: Mapping[str, Any]
            additional parameters used to initialize custom
            Parameterizer.
    ...
    @classmethod
    def setup_inputs(
        cls, input_dims: int, libsize_scaling: bool = False, **kwargs
    ) -> Mapping[str, tf.keras.Input]:
        """Builder function to setup the inputs tensors using
        Tensorflow functional API. Developers can overwrite this
        function to create custom Parameterizer.
    ...
    def modify_outputs(
        ...
        **kwargs,
        ...
        """Postprocess the parameters created by layers.parameterizer.
        In particular, it allows libsize scaling and exponential
        transform. Developers can overwrite this function to create
    ...
    def make(
        ...
        **kwargs,
        ...
        event_dims: int
            ...
            (not the actuall outputs dimensions, which will be
        ...
        kwargs: Mapping[str, Any]
            ...
            building parameterizer layer and modify_outputs() function.
