...
class MixtureMultivariateNormalDiagParameterizer(Parameterizer):
    ...
    3.  outputs[..., component, p+1:] will be used as the scale_diag
        (std).
    ...
    See Also
    --------
    distributions.MixtureMultivariateNormalDiagDistribution
        the compatible distribution

    layers.parameterizer.MixtureMultivariateNormalDiagParameterizer
