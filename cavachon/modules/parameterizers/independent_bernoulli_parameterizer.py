...
class IndependentBernoulliParameterizer(Parameterizer):
    ...
    the logits for IndependentBernoulli distribution.
    ...
    See Also
    --------
    distributions.IndependentBernoulliDistribution
        the compatible distribution.

    layers.parameterizer.IndependentBernoulli
