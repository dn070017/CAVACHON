...
class DecoderDataParameterizer(tf.keras.Model):
    ...
    Decoder and parameterizer for data distributions. This base module
    is implemented with Tensorflow sequential API.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        ----------
        distribution_name: str
            distribution name for the modality to be decoded. By
            default, this is used to automatically find the
            parameterizer in modules.parameterizers

        n_vars: int, optional:
            number of event dimension for data distributions. Defaults
            to 5.

        n_layers: int, optional
            number of layers constructed in the backbone network.
            Defaults to 3.
    ...
    def call(
        ...
        inputs: Mapping[str, tf.Tensor]
            ...
            'libsize' (if applicable). (by defaults, expect the outputs
        ...
        result = self.x_parameterizer(
            x_parameterizer_inputs, training=training, mask=mask
        )
