...
from cavachon.layers.modifiers.distribution_modeled_data_presets.multivariate_normal_diag_modeled_data_modifier import (
...
def modifier(modality_name):
    return MultivariateNormalDiagModeledDataModifier(modality_name=modality_name)


def test_init(modifier, modality_name):
    assert isinstance(modifier, MultivariateNormalDiagModeledDataModifier)
